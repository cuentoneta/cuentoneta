...
| `pnpm corpus:generate`                    | Regenera las fixtures raw del corpus de mocks de Onoff (`literary-work`/`collection`) evaluando la query GROQ real con `groq-js` sobre los documentos escritos a mano → [`src/mocks/onoff/README.md`](src/mocks/onoff/README.md)            |
