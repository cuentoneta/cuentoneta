...
| Config de componentes/directivas/servicios                | **Prohibido** el `const` de módulo no exportado con literal de objeto o arreglo — va como `private readonly` de instancia (ESLint `component-config-in-class`) → [`angular-components.md`](.claude/references/angular-components.md#configuración-de-la-clase)                                                                                                 |
