...
| `pnpm issue-refs:sweep`                   | Verifica que los issues citados en el repo sigan abiertos y reporta los que no; con `--apply` mantiene el issue de seguimiento. Lo corre un job programado, **no** un gate                |
