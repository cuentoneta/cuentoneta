...
| `pnpm seo:index-status`                   | Mide el estado de indexado real contra la URL Inspection API de Search Console (requiere service account: `GSC_SERVICE_ACCOUNT_KEY_PATH` o `GSC_SERVICE_ACCOUNT_KEY`, más `GSC_SITE_URL`)                                                       |
