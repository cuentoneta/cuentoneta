...
**La conversión falló antes que perder contenido.** Tanto el conversor como el armado del documento lanzaban ante lo que no podían traducir, en vez de degradar el resultado: un documento a medio convertir habría fallado recién al leerse, cuando el repository construye el agregado con sus factories — lejos de donde se podía corregir.
