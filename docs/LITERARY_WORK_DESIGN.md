...
| Pieza             | Contrato                                                                                                                                                                                                                                                                                                                                             |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Tipo de wire**  | `LiteraryWorkDto`: la misma forma del agregado serializado (`slug: string`, `title?: { value: string }` — el `SectionTitle` `{ value, toAnchor() }` pierde el método al cruzar JSON, `bodyHtml: string`, …). Vive junto a `literary-work-api.interface.ts` (convención de API providers). Es **tipado, no una capa**: no hay transformación de shape |
