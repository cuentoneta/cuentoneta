...
```bash
pnpm exec sanity migration run draft-story-to-literary-work --project "$(node --env-file=.env -p 'process.env.SANITY_STUDIO_PROJECT_ID')" --dataset <ds> > dry-run.log
```
...
```bash
pnpm exec sanity migration run draft-story-to-literary-work --project "$(node --env-file=.env -p 'process.env.SANITY_STUDIO_PROJECT_ID')" --dataset <ds> --no-dry-run
```
...
```bash
pnpm exec sanity migration run revert-draft-story-to-literary-work --project "$(node --env-file=.env -p 'process.env.SANITY_STUDIO_PROJECT_ID')" --dataset <ds>
pnpm exec sanity migration run revert-draft-story-to-literary-work --project "$(node --env-file=.env -p 'process.env.SANITY_STUDIO_PROJECT_ID')" --dataset <ds> --no-dry-run
```
