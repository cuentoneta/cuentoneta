...
La habilitación sigue siendo más amplia que la necesidad: esos dos programas también incluyen `src/`, `e2e/` y `resources/`. Lo que acota el uso es la convención, no el compilador — un import con extensión fuera de la cadena del hook es incorrecto y se marca en review.
