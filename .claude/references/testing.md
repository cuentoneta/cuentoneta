...
| Un teaser de obra con multimedia                    | `onoffLiteraryWorkTeasersWithMediaSourcesMock` enriquece **todo** el canon; `onoffLiteraryWorkTeasersWithMediaSources` conserva solo las obras que declaran medios propias. Elegí por el predicado |
