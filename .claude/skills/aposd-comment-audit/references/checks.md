...
- **Anotaciones de unidad en hojas de estilo** — el `/* 10px */` junto a una custom property que declara su valor en `rem`. Traducen una unidad a la que el lector calcula mentalmente; no son un censo (C15) ni un eco, porque el valor anotado no está escrito en la línea.
