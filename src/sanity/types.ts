...
// Query: {	"literaryWorks": *[_type == "literaryWork" && !(_id in path('drafts.**'))]{ "slug": slug.current, "lastmod": coalesce(publishedAt, _createdAt) },	"authors": *[_type == "author" && !(_id in path('drafts.**'))]{ "slug": slug.current, "lastmod": _createdAt },	"collections": *[_type == "collection" && !(_id in path('drafts.**'))]{ "slug": slug.current, "lastmod": _createdAt }}
