...
// Source: ../src/api/_queries/author.query.ts
// Variable: reconcileAuthorTagsAuthorsQuery
// Query: *[_type == 'author' && !(_id in path('drafts.**'))] {    _id,    'tags': coalesce(tags[]{ _key, _ref }, [])}
export type ReconcileAuthorTagsAuthorsQueryResult = Array<{
	_id: string;
	tags:
		| Array<{
				_key: string;
...
// Source: ../src/api/_queries/literary-work.query.ts
// Variable: reconcileAuthorTagsWorksQuery
// Query: *[_type == 'literaryWork' && !(_id in path('drafts.**'))] {    'authorRefs': coalesce(authors[]._ref, []),    'tagRefs': coalesce(tags[]._ref, [])}
export type ReconcileAuthorTagsWorksQueryResult = Array<{
	authorRefs: Array<string>;
	tagRefs: Array<string> | Array<never>;
}>;
...
declare module '@sanity/client' {
	interface SanityQueries {
		...
		"\n*[_type == 'author' && !(_id in path('drafts.**'))] {\n    _id,\n    'tags': coalesce(tags[]{ _key, _ref }, [])\n}": ReconcileAuthorTagsAuthorsQueryResult;
