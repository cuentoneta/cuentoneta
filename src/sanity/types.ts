...
export type CollectionBySlugQueryResult = {
	...
	literaryWorks:
		| Array<{
				...
				openingReadingTime: number | null;
				readingTimeFallbackBody: Markdown | null;
		  }>
		| Array<never>;
} | null;
