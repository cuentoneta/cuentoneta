...
// Source: ../src/api/_queries/content.query.ts
// Variable: literaryWorkIdsBySlugsQuery
// Query: *[_type == 'literaryWork' && !(_id in path('drafts.**')) && slug.current in $slugs]{    _id,    'slug': slug.current}
export type LiteraryWorkIdsBySlugsQueryResult = Array<{
	_id: string;
	slug: string;
}>;
