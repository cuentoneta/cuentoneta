...
// desde que el raw se genera, ninguna deriva de la otra. Los strings viven acá para que no puedan
// divergir, la misma convención que el corpus ya usa para títulos y epígrafes.

// El título de la primera sección no se repite acá: es el mismo que el del canon, y declararlo dos veces
// dejaba al generador eligiendo cuál importar según el orden del sistema de archivos.
