...
//
// Se deriva de la cara de obra literaria, que la genera el generador evaluando la query real, en vez de
// declararse aparte: las dos proyecciones resuelven `audioUrl` igual, así que declararlas por separado
// dejaría que se desincronicen sin que nada avise. El tipo es el de la cara Story a propósito — que
// ambas caras lo satisfagan es la invariante que este espejo afirma.
