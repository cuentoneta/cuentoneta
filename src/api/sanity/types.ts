...
// Query: {	"stories": *[_type == "story" && !(_id in path('drafts.**'))]{ "slug": slug.current },	"authors": *[_type == "author" && !(_id in path('drafts.**'))]{ "slug": slug.current },	"storylists": *[_type == "storylist" && !(_id in path('drafts.**'))]{ "slug": slug.current }}
