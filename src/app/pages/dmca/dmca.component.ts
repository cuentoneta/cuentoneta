  ...
  template: `
    <main class="lg:mt-28">
      ...
      <section class="mb-8">
        ...
        <p>
          All the information on this website - cuentoneta.ar - is published in
          good faith and for general information purpose only. La Cuentoneta
          ...
          you find on this website (La Cuentoneta), is strictly at your own
          risk. La Cuentoneta will not be liable for any losses and/or damages
        ...
        <br />
        <p>
          La Cuentoneta respects the intellectual property of others.
          cuentoneta.ar takes matters of Intellectual Property very seriously
          and is committed to meeting the needs of content owners while helping
          them manage publication of their content online. It should be noted
          that cuentoneta.ar only reproduces information already available in
          other websites, which are linked below with information about where
          each story has been taken from.
        </p>
        <br />
        <p>
          ...
          providing notice of the claimed copyright infringement: A physical or
          electronic signature of a person authorized to act on behalf of the
          copyright owner Identification of the copyrighted work claimed to have
          been infringed Identification of the material that is claimed to be
          infringing or to be the subject of the infringing activity and that is
          to be removed Information reasonably sufficient to permit the service
          provider to contact the complaining party, such as an address,
          telephone number, and, if available, an electronic mail address A
          statement that the complaining party "in good faith believes that use
          of the material in the manner complained of is not authorized by the
          copyright owner, its agent, or law" A statement that the "information
          in the notification is accurate", and "under penalty of perjury, the
          complaining party is authorized to act on behalf of the owner of an
          exclusive right that is allegedly infringed" The above information
          must be submitted as a written, faxed or emailed notification to the
          following Designated Agent: Attn: DMCA Office Contact Us :
