...
@Component({
	...
	template: `
		<div class="mx-auto mt-8 w-full max-w-310 px-4 pb-16 md:mt-20">
			<div class="bg-neutral-50 p-5 shadow-lg md:rounded-xl md:p-16">
				...
				<section class="mb-8">
					...
					<p class="font-inter text-base font-normal">
						...
						publication of their content online. It should be noted that cuentoneta.ar only reproduces information
						already available in other websites, which are linked below with information about where each story has been
						taken from.
					</p>
					<br />
					<p class="font-inter text-base font-normal">
						If you believe that your copyrighted work has been copied in a way that constitutes copyright infringement
						and is accessible on this site, you may notify our copyright agent, as set forth in the
						...
						notice of the claimed copyright infringement: A physical or electronic signature of a person authorized to
						act on behalf of the copyright owner Identification of the copyrighted work claimed to have been infringed
						Identification of the material that is claimed to be infringing or to be the subject of the infringing
						activity and that is to be removed Information reasonably sufficient to permit the service provider to
						contact the complaining party, such as an address, telephone number, and, if available, an electronic mail
						address A statement that the complaining party "in good faith believes that use of the material in the
						manner complained of is not authorized by the copyright owner, its agent, or law" A statement that the
						"information in the notification is accurate", and "under penalty of perjury, the complaining party is
						authorized to act on behalf of the owner of an exclusive right that is allegedly infringed" The above
						information must be submitted as a written, faxed or emailed notification to the following Designated Agent:
						Attn: DMCA Office Contact Us : http://www.watchdogsecurity.online
					</p>
					<br />
					<p class="font-inter text-base font-normal">
				...
				<section class="mb-8">
					...
					<p class="font-inter text-base font-normal">
						In order to demonstrate that La Cuentoneta solely serves as a platform for reproducing existing content,
						each non-original asset sourced from external contributors and other platforms includes a prominently
