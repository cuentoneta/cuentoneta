...
function layoutAt(viewport: Viewport): EnvironmentProviders {
	...
	return provideLayoutMock(layout);
}

function renderCarousel(viewport: Viewport = 'md') {
	return render(CarouselComponent, {
		inputs: { slides: contentCampaignMock },
		providers: [layoutAt(viewport)],
	});
}
...
describe('CarouselComponent', () => {
	...
	it('should receive and render slides correctly', async () => {
		const { fixture } = await renderCarousel();
