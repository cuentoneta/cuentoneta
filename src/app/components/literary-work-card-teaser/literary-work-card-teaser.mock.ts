	...
	content: [
		createLiteraryWorkSection({
			...
			bodyHtml: createSanitizedHtml(
				'<p>Al cruzar la primera frontera, el visitante olvida el motivo de su viaje y recuerda, en cambio, todos los viajes que no hizo. <strong>El palacio</strong> se reordena cada noche: sus galerías cambian de lugar, sus espejos devuelven rostros ajenos y sus bibliotecas archivan cartas que nadie escribió todavía.</p><p>Quien alcanza la novena frontera descubre que el palacio no tiene salida, sino <em>memoria</em>: cada puerta abierta es un recuerdo que se defiende de ser olvidado, y cada umbral cruzado reescribe el itinerario completo del viaje.</p>',
			),
