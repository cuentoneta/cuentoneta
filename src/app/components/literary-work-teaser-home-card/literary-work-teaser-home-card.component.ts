 ...
 * LiteraryWorkTeaserCard pero con un propósito propio: layout vertical angosto con la imagen, la
 ...
 */
@Component({
	selector: 'cuentoneta-literary-work-teaser-home-card',
	imports: [
		RouterLink,
	...
	template: `
		@if (literaryWork(); as literaryWork) {
			...
			<cuentoneta-literary-work-teaser-home-card-skeleton data-testid="skeleton" />
		}
	`,
	host: {
...
export class LiteraryWorkTeaserHomeCardComponent {
