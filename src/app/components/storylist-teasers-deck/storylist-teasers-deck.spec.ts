...
// Componentes
import { StorylistTeasersDeck } from './storylist-teasers-deck';
...
describe('StorylistTeasersDeck', () => {
	// Providers necesarios para las pruebas
	const defaultProviders = [provideRouter([])];

	// Imports por defecto incluyendo los componentes reales
	const defaultImports = [StorylistTeasersDeck, StorylistTeaserCard, CollectionTeaserCardSkeletonComponent];

	// Pruebas de renderizado básico
	describe('Renderizado del componente', () => {
		it('should render the component', async () => {
			const { container } = await render(StorylistTeasersDeck, {
				inputs: { teasers: [] },
		...
		it('should display the section title', async () => {
			await render(StorylistTeasersDeck, {
				inputs: { teasers: [] },
				providers: defaultProviders,
				componentImports: defaultImports,
			});
	...
	describe('Comportamiento del bloque defer', () => {
		it('should render skeletons in loading state', async () => {
			const { fixture } = await render(StorylistTeasersDeck, {
