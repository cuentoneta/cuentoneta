...
import { embedPlaceholdersDecorator, withEmbedPlaceholder } from '@testing/storybook-embed-placeholders';
...
export const Widget: Story = {
	args: {
		media: withEmbedPlaceholder(onoffSpotifyPodcastEpisodesMock[0]),
	},
};
