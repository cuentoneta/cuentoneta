...
const meta: Meta<ReadingSuggestionsListComponent> = {
	...
	argTypes: {
		...
		teasers: {
			control: false,
			description:
				'Sugerencias ya resueltas, cada una con el extracto del arranque de la obra. El bloque no se renderiza si llega vacío. En el catálogo las deriva el control de cantidad',
