 ...
 *
 * Consume los teasers nativos del módulo LiteraryWork (GET /literary-work/author/:slug): la tarjeta
 * toma el extracto del propio teaser, sin traducción intermedia.
 *
