 ...
 *
 * Consume la colección nativa del módulo Collection (GET /collection/:slug), que transporta sus
 * obras como teasers de LiteraryWork: la tarjeta toma el extracto del propio teaser, sin traducción
 * intermedia. Muestra el autor de cada obra: una colección puede reunir obras de varios.
 */
@Component({
